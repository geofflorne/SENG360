...
public class AES{
  ...
  private static int[] inv_subBytes(int[] state){
    for(int i = 0; i < 16; i++){
  ...
  private static int[] inv_shiftRows(int[] state){
    int[] temp = new int[16];
  ...
  private static int[] inv_mixColumns(int[] state){
    int[] tmp = new int[16];
